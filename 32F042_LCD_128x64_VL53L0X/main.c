...
#include "VL53L0X.h"					// Lidar Driver
#include "SSD1306.h"					// 128x64 Oled 0.96" driver
...
delay_ms(200);	
LCD_Init();LCD_Clear();
LCD_Gotoxy (5,0);LCD_PrintStr(" TEST VL53L0X ",1);
	
init_VL53L0X();
LCD_Gotoxy (5,2);LCD_PrintStr(" Revision ",0);LCD_PrintDec(VL53L0X_readReg(IDENTIFICATION_REVISION_ID),0);		 
...
//delay_ms(100);
LCD_Gotoxy (1,4);LCD_PrintStr("Range, mm =",0);	LCD_PrintDec(VL53L0X_readRangeSingleMillimeters(),0);LCD_PrintStr("   ",0);
